...
namespace LolFightProjekat.Controllers
{
    public class NewsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include="IdNews,Title,Text")] News news)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include="IdNews,Title,Text")] News news)
        {
            if (ModelState.IsValid)
            {
